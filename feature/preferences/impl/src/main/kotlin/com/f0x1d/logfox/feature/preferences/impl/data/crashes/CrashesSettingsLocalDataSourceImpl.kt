...
internal class CrashesSettingsLocalDataSourceImpl @Inject constructor(
    ...
    override fun collectingFor(crashTypeName: String): Boolean = collectingForPreference(crashTypeName).get()
    ...
    override fun showingNotificationsFor(crashTypeName: String): Boolean = showingNotificationsForPreference(crashTypeName).get()
