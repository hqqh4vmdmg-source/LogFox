...
internal abstract class BasePreferences(context: Context) {
    ...
    protected open fun providePreferences(context: Context): SharedPreferences =
        PreferenceManager.getDefaultSharedPreferences(context)

    protected fun booleanPreference(key: String, defaultValue: Boolean): Preference<Boolean> =
        flowSharedPreferences.getBoolean(key, defaultValue)

    protected fun intPreference(key: String, defaultValue: Int): Preference<Int> =
        flowSharedPreferences.getInt(key, defaultValue)

    protected fun longPreference(key: String, defaultValue: Long): Preference<Long> =
        flowSharedPreferences.getLong(key, defaultValue)

    protected fun stringPreference(key: String, defaultValue: String): Preference<String> =
