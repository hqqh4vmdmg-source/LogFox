...
@Composable
internal fun PreferencesLinksScreen(
    onBack: () -> Unit,
    onCommand: (PreferencesLinksCommand) -> Unit,
) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        LazyColumn(
            ...
            item {
                SettingsLinkRow(
                    ...
                    onClick = { onCommand(PreferencesLinksCommand.OpenUrl("https://t.me/f0x1d")) },
                )
            }
            item {
                SettingsLinkRow(
                    ...
                    onClick = { onCommand(PreferencesLinksCommand.OpenUrl("https://github.com/F0x1d/LogFox")) },
                )
            }
            item {
            ...
            item {
                SettingsLinkRow(
                    ...
                    onClick = { onCommand(PreferencesLinksCommand.OpenUrl("https://t.me/f0x1dsshit")) },
                )
            }
            item {
                SettingsLinkRow(
                    ...
                    onClick = { onCommand(PreferencesLinksCommand.OpenUrl("https://t.me/f0x1dsshit_ci")) },
                )
            }
        }
    }
